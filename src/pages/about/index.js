  ...
  return (
    <div className="md:flex md:flex-wrap -mt-10 md:mt-0 md:pt-14 justify-between text-2xl text-white">
      <div className="md:flex md:flex-wrap p-8">
        <div className="flex flex-wrap md:justify-between md:pb-20 w-fit">
          <div className="text-justify first-letter:font-extrabold first-letter:text-4xl first-line:italic lg:w-2/5 pb-10">
          John white is an up-and-coming artist born and raised in South LA. Exploring the sounds of the bands he listened to with his father, John writes about love, loss, and acceptance in a way that can be understood by all. At the end of the day. his message is about embracing one another regardless of race, class, sexuality, and coming together through music to understand that we are not alone.
        ...
        <br/>
          ...
          <div className="flex justify-center pb-4">
            <div className=" w-min h-min font-bold p-5 border-spacing-0 border-2 rounded-xl">
              <a className="text-center text-sm" href={oneSheet} download>
                <p>download one sheet</p>
                <p className="text-9xl p-4">📝</p>
              </a>
            </div>
          </div>
