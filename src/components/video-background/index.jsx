...
const VideoBackground = () => {
  return (
    <video
      ...
      className="brightness-50 translate-x-14 blur saturate-0 w-full h-full object-cover scale-[120%] fixed z-[-1] bg-black overflow-clip md:overflow-hidden flex md:align-middle md:content-center"
    >
