...
export interface ApiAlbumAlbum extends Schema.CollectionType {
  ...
  attributes: {
    ...
    SoundcloudURL: Attribute.String;
    YoutubeURL: Attribute.String;
    AppleMusicURL: Attribute.String;
    ReleaseType: Attribute.Enumeration<['LP', 'Single', 'EP']>;
    ReleaseTitle: Attribute.String & Attribute.Required;
    TidalURL: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiMusicEmbeddedIdMusicEmbeddedId extends Schema.SingleType {
  ...
  info: {
    singularName: 'music-embedded-id';
    pluralName: 'music-embedded-ids';
    displayName: 'MusicEmbeds';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    spotifyEmbedURL: Attribute.String;
    soundcloudEmbedURL: Attribute.String;
    appleMusicEmbedURL: Attribute.String;
    Text: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::music-embedded-id.music-embedded-id',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiPressHighlightPressHighlight extends Schema.CollectionType {
  collectionName: 'press_highlights';
  info: {
    singularName: 'press-highlight';
    pluralName: 'press-highlights';
    displayName: 'PressHighlight';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::press-highlight.press-highlight',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiYoutubeMusicVideoUrlYoutubeMusicVideoUrl
  ...
  info: {
    singularName: 'youtube-music-video-url';
    pluralName: 'youtube-music-video-urls';
    displayName: 'YoutubeMusicVideoURL';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    YoutubeID: Attribute.String & Attribute.Required & Attribute.Unique;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::youtube-music-video-url.youtube-music-video-url',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
